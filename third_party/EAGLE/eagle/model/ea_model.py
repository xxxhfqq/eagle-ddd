...
class EaModel(nn.Module):
    ...
    def __init__(
        ...
        self.enable_ddd = enable_ddd
        self.ddd_max_depth = ddd_max_depth
        self.ddd_check_depths = ddd_check_depths
    ...
    def from_pretrained(
        ...
        enable_ddd = kwargs.pop("enable_ddd", False)
        ddd_max_depth = kwargs.pop("ddd_max_depth", None)
        ddd_check_depths = kwargs.pop("ddd_check_depths", (5, 7, 9))
        ddd_threshold = kwargs.pop("ddd_threshold", -2.0)
        ...
        if Type == 'LlamaForCausalLM':
            ...
            if KVQwen3ForCausalLM is None:
                raise ImportError("Qwen3ForCausalLM is unavailable in this transformers/EAGLE build.")
        ...
        model = cls(
            ...
            ddd_check_depths=ddd_check_depths,
